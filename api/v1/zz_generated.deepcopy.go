...
func (in *InputRevisions) DeepCopyInto(out *InputRevisions) {
	*out = *in
	...
	if in.CompositionGeneration != nil {
		in, out := &in.CompositionGeneration, &out.CompositionGeneration
		*out = new(int64)
		**out = **in
	}
}
...
func (in *ResourceState) DeepCopyInto(out *ResourceState) {
	*out = *in
	...
	if in.ReconciliationError != nil {
		in, out := &in.ReconciliationError, &out.ReconciliationError
		*out = new(string)
		**out = **in
	}
}
